function pingAPI() {
    ...
    formData.append('trackdrive_number', '+12097132386');
    formData.append('traffic_source_id', '992343');
    api_tester(document.getElementById('caller_id').value);
    formData.append('caller_id', '+1' + document.getElementById('caller_id').value);


    
const originalUrl = 'https://callrouter.trackdrive.com/api/v1/inbound_webhooks/ping/check_if_the_aca_buyer_is_available_to_take_the_call?' + new URLSearchParams(formData).toString();
...
function postPingId(pingId) {
    const postData = {
        trackdrive_number: "+12097132386",
        traffic_source_id: "992343",
    ...
    const originalUrl = 'https://callrouter.trackdrive.com/api/v1/inbound_webhooks/post/check_if_the_aca_buyer_is_available_to_take_the_call?' + new URLSearchParams(postData).toString();;
