function pingAPI() {
    ...
    formData.append('trackdrive_number', '+18445660603');
...
const originalUrl = 'https://skymarketinggroup.trackdrive.com/api/v1/inbound_webhooks/ping/check_pest_agents?' + new URLSearchParams(formData).toString();
...
function postPingId(pingId) {
    ...
    const originalUrl = 'https://skymarketinggroup.trackdrive.com/api/v1/inbound_webhooks/post/check_pest_agents?' + new URLSearchParams(postData).toString();
