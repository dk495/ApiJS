document.getElementById('leadForm').addEventListener('submit', function(event) {
    ...
    const lead = {
        data: {
            ...
            hvac_project_type: form.hvac_project_type.value,
            hvac_air_type: form.hvac_air_type.value,
            hvac_system_type: form.hvac_system_type.value
        },
        meta: {
    ...
    fetch(pingUrl, {
        method: 'POST',
        headers: {
            'Authorization': 'Bearer bb07f296-ac5d-4a53-97db-af30196c15bc',
