function pingAPI() {
    ...
    formData.append('trackdrive_number', '+18772887273');
...
const originalUrl = 'https://assured-health.trackdrive.com/api/v1/inbound_webhooks/ping/check_for_the_available_buyers?' + new URLSearchParams(formData).toString();
...
function postPingId(pingId) {
    ...
    const originalUrl = 'https://assured-health.trackdrive.com/api/v1/inbound_webhooks/post/check_for_the_available_buyers?' + new URLSearchParams(postData).toString();
