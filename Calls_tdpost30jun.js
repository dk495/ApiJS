...
document.getElementById('submitBtn').disabled = true;
    ...
    formData.append('lead_token', '45d5444eac1944a694ac5de08f6d09f4');
    ...
    formData.append('source_url', 'https://quotes.kproinsurance.com/ssdi/');
            ...
            const url = 'https://the-lead-penguin.trackdrive.com/api/v1/leads/capture?' + new URLSearchParams(formData).toString();
