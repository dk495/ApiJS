function pingAPI() {
    ...
    formData.append('trackdrive_number', '+18774340616');
    formData.append('traffic_source_id', '1055');
...
const originalUrl = 'https://synegence-llc.trackdrive.com/api/v1/inbound_webhooks/ping/check_for_available_buyers_on_auto_insurance?' + new URLSearchParams(formData).toString();
...
function postPingId(pingId) {
    const postData = {
        trackdrive_number: "+18774340616",
        traffic_source_id: "1055",
    ...
    const originalUrl = 'https://synegence-llc.trackdrive.com/api/v1/inbound_webhooks/post/check_for_available_buyers_on_auto_insurance?' + new URLSearchParams(postData).toString();
