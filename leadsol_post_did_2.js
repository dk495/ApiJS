...
formData.append('country_code', '+1'); 
            ...
            const originalUrl = 'https://callin.dialerzone.com/config/non_agent_api.php?source=vendorleads&function=add_lead&user=API_LEAD&pass=Hak0matata&custom_fields=Y&list_id=548472=&vendor_lead_code=&source_id=&phone_code=&' + new URLSearchParams(formData).toString();
