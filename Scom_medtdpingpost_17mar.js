function pingAPI() {
    ...
    formData.append('trackdrive_number', '+18336452627');
...
const originalUrl = 'https://crowned-trust-insurance.trackdrive.com/api/v1/inbound_webhooks/ping/check_for_available_medicare_buyers?' + new URLSearchParams(formData).toString();
...
function postPingId(pingId) {
    ...
    const originalUrl = 'https://crowned-trust-insurance.trackdrive.com/api/v1/inbound_webhooks/post/check_for_available_medicare_buyers?' + new URLSearchParams(postData).toString();
