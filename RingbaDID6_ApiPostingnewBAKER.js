    document.getElementById('leadForm').addEventListener('submit', function(event) {
		...
		api_tester(document.getElementById('caller_id').value);
            ...
            formData.append('cert', document.getElementById('jornaya_leadid').value);
            ...
            const url = 'https://display.ringba.com/enrich/2401264924224390737?' + new URLSearchParams(formData).toString();
