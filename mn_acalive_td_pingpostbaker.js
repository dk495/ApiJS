function pingAPI() {
    ...
    formData.append('trackdrive_number', '+18442234708');
api_tester(document.getElementById('caller_id').value);
    formData.append('traffic_source_id', '1048');
    
    formData.append('caller_id', '+1' + document.getElementById('caller_id').value);

const originalUrl = 'https://massnexus-llc.trackdrive.com/api/v1/inbound_webhooks/ping/check_for_available_buyers_on_aca?' + new URLSearchParams(formData).toString();
...
function postPingId(pingId) {
    const postData = {
        trackdrive_number: "+18442234708",
        traffic_source_id: "1048",
    ...
    const originalUrl = 'https://massnexus-llc.trackdrive.com/api/v1/inbound_webhooks/post/check_for_available_buyers_on_aca?' + new URLSearchParams(postData).toString();;
