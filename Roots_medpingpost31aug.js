function pingAPI() {
    ...
    formData.append('trackdrive_number', '+18885951491');
...
const originalUrl = 'https://coffeeblack-marketing.trackdrive.com/api/v1/inbound_webhooks/ping/check_for_available_buyers_on_medicare_inbound_rtb?' + new URLSearchParams(formData).toString();
...
function postPingId(pingId) {
    ...
    const originalUrl = 'https://coffeeblack-marketing.trackdrive.com/api/v1/inbound_webhooks/post/check_for_available_buyers_on_medicare_inbound_rtb?' + new URLSearchParams(postData).toString();;
