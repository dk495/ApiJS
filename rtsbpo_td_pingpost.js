function pingAPI() {
    ...
    formData.append('trackdrive_number', '+18882880511');
    formData.append('traffic_source_id', '1006');
    api_tester(document.getElementById('caller_id').value);
    formData.append('caller_id', '+1' + document.getElementById('caller_id').value);

    
const originalUrl = 'https://rts-bpo.trackdrive.com/api/v1/inbound_webhooks/ping/check_for_available_buyer?' + new URLSearchParams(formData).toString();
...
function postPingId(pingId) {
    const postData = {
        trackdrive_number: "+18882880511",
        traffic_source_id: "1006",
    ...
    const originalUrl = 'https://rts-bpo.trackdrive.com/api/v1/inbound_webhooks/post/check_for_available_buyer?' + new URLSearchParams(postData).toString();;
