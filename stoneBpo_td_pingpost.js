function pingAPI() {
    ...
    formData.append('trackdrive_number', '+18443696825');
...
function postPingId(pingId) {
    ...
    const originalUrl = 'https://verbalking.trackdrive.com/api/v1/inbound_webhooks/post/check_medicare_buyer_availabilityr';
