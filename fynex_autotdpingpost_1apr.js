function pingAPI() {
    ...
    formData.append('trackdrive_number', '+12097064050');
    formData.append('traffic_source_id', '12925');
...
const originalUrl = 'https://elite-calls-com.trackdrive.com/api/v1/inbound_webhooks/ping/check_for_auto_insurance_buyers?' + new URLSearchParams(formData).toString();
...
function postPingId(pingId) {
    const postData = {
        trackdrive_number: "+12097064050",
        traffic_source_id: "12925",
    ...
    const originalUrl = 'https://elite-calls-com.trackdrive.com/api/v1/inbound_webhooks/post/check_for_auto_insurance_buyers?' + new URLSearchParams(postData).toString();
