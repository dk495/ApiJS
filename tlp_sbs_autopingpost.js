    ...
    const formData = new FormData();
     formData.append('trackdrive_number', '+18334861831');
...
const originalUrl = 'https://the-lead-penguin.trackdrive.com/api/v1/inbound_webhooks/ping/check_for_available_buyers_on_auto_ib?' + new URLSearchParams(formData).toString();
...
function postPingId(pingId) {
    const postData = {
        trackdrive_number: "+18334861831",
        traffic_source_id: "TS00008",
...
state_minimum:document.getElementById('state_minimum').value
    ...
    const originalUrl = 'https://the-lead-penguin.trackdrive.com/api/v1/inbound_webhooks/post/check_for_available_buyers_on_auto_ib?' + new URLSearchParams(postData).toString();
