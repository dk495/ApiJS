function pingAPI() {
    ...
    formData.append('trackdrive_number', '+12097064418');
    formData.append('traffic_source_id', '12418');
...
const originalUrl = 'https://elite-calls-com.trackdrive.com/api/v1/inbound_webhooks/ping/hospital_indemnity_agents?' + new URLSearchParams(formData).toString();
...
function postPingId(pingId) {
    const postData = {
        trackdrive_number: "+12097064418",
        traffic_source_id: "12418",
    ...
    const originalUrl = 'https://elite-calls-com.trackdrive.com/api/v1/inbound_webhooks/post/hospital_indemnity_agents?' + new URLSearchParams(postData).toString();
