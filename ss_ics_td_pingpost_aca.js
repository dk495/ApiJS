function pingAPI() {
    ...
    formData.append('trackdrive_number', '+18444677872');
...
const originalUrl = 'https://innovative-call-solutions.trackdrive.com/api/v1/inbound_webhooks/ping/check_innovative_call_solutions_buyers_aca?' + new URLSearchParams(formData).toString();
...
function postPingId(pingId) {
    ...
    const originalUrl = 'https://innovative-call-solutions.trackdrive.com/api/v1/inbound_webhooks/post/check_innovative_call_solutions_buyers_aca?' + new URLSearchParams(postData).toString();;
