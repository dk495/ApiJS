document.getElementById('leadForm').addEventListener('submit', function(event) {
    ...
    const lead = {
        data: {
            ...
            gutters_material_type: form.gutters_material_type.value,
            gutters_project_type: form.hvac_air_type.value,
            gutters_protection: form.gutters_protection.value
        },
        meta: {
    ...
    fetch(pingUrl, {
        method: 'POST',
        headers: {
            'Authorization': 'Bearer e2caf2e1-175e-4240-ba07-aa6691c7352e',
