function pingAPI() {
    ...
    formData.append('trackdrive_number', '+18882811245');
...
const originalUrl = 'https://capitalmediaagency.trackdrive.com/api/v1/inbound_webhooks/ping/check_for_available_aca_inbounds?' + new URLSearchParams(formData).toString();
...
function postPingId(pingId) {
    ...
    const originalUrl = 'https://capitalmediaagency.trackdrive.com/api/v1/inbound_webhooks/post/check_for_available_aca_inbounds?' + new URLSearchParams(postData).toString();
