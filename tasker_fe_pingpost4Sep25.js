function pingAPI() {
    ...
    formData.append('trackdrive_number', '+18446750936');
    formData.append('traffic_source_id', '222');
    api_tester(document.getElementById('caller_id').value);
    formData.append('caller_id', '+1' + document.getElementById('caller_id').value);


    
const originalUrl = 'https://ags-leads-llc.trackdrive.com/api/v1/inbound_webhooks/ping/check_for_available_fe_buyers?' + new URLSearchParams(formData).toString();
...
function postPingId(pingId) {
    ...
    const originalUrl = 'https://ags-leads-llc.trackdrive.com/api/v1/inbound_webhooks/post/check_for_available_fe_buyers?' + new URLSearchParams(postData).toString();;
