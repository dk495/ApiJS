function pingAPI() {
    ...
    formData.append('trackdrive_number', '+18882848863');
...
const originalUrl = 'https://yourhomefixer.trackdrive.com/api/v1/inbound_webhooks/ping/check_for_available_agents_on_medicare_transfers?' + new URLSearchParams(formData).toString();
...
function postPingId(pingId) {
    ...
    const originalUrl = 'https://yourhomefixer.trackdrive.com/api/v1/inbound_webhooks/post/check_for_available_agents_on_medicare_transfers?' + new URLSearchParams(postData).toString();;
