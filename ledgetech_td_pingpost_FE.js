function pingAPI() {
    ...
    formData.append('trackdrive_number', '+18556352816');
    formData.append('traffic_source_id', '1012');
...
const originalUrl = 'https://chair-21-media.trackdrive.com/api/v1/inbound_webhooks/ping/check_for_availbale_agents_on_final_expense?' + new URLSearchParams(formData).toString();
...
function postPingId(pingId) {
    const postData = {
        trackdrive_number: "+18556352816",
        traffic_source_id: "1012",
    ...
    const originalUrl = 'https://chair-21-media.trackdrive.com/api/v1/inbound_webhooks/post/check_for_availbale_agents_on_final_expense?' + new URLSearchParams(postData).toString();;
