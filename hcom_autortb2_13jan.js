document.getElementById('leadForm').addEventListener('submit', function(event) {
    ...
    const url = 'https://corsproxy.io/?https://rtb.ringba.com/v1/production/32c482e139a74caebb21f5145683e72b.json?exposeCallerId=yes&' + new URLSearchParams(formData).toString();
