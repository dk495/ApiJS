function pingAPI() {
    ...
    formData.append('trackdrive_number', '+18444414199');
    formData.append('traffic_source_id', 'TS00017');
...
const originalUrl = 'https://the-lead-penguin.trackdrive.com/api/v1/inbound_webhooks/ping/check_for_available_final_expense_inbounds?' + new URLSearchParams(formData).toString();
...
function postPingId(pingId) {
    const postData = {
        trackdrive_number: "+18444414199",
        traffic_source_id: "TS00017",
    ...
    const originalUrl = 'https://the-lead-penguin.trackdrive.com/api/v1/inbound_webhooks/post/check_for_available_final_expense_inbounds?' + new URLSearchParams(postData).toString();
