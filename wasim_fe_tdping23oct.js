function pingAPI() {
    ...
    formData.append('trackdrive_number', '+18334117873');
...
const originalUrl = 'https://the-upper-echelon.trackdrive.com/api/v1/inbound_webhooks/ping/check_for_final_expense_buyers?' + new URLSearchParams(formData).toString();
...
function postPingId(pingId) {
    ...
    const originalUrl = 'https://the-upper-echelon.trackdrive.com/api/v1/inbound_webhooks/post/check_for_final_expense_buyers?' + new URLSearchParams(postData).toString();;
