...
function postPingId(pingId) {
    const postData = {
        trackdrive_number: "+18442272167",
        traffic_source_id: "1073",
    ...
    const originalUrl = 'https://verbalking.trackdrive.com/api/v1/inbound_webhooks/post/check_for_available_aca_buyer';
