function pingAPI() {
    ...
    formData.append('trackdrive_number', '+12092159826');
...
const originalUrl = 'https://elite-calls-com.trackdrive.com/api/v1/inbound_webhooks/ping/check_for_available_med_agents?' + new URLSearchParams(formData).toString();
...
function postPingId(pingId) {
    ...
    const originalUrl = 'https://elite-calls-com.trackdrive.com/api/v1/inbound_webhooks/post/check_for_available_med_agents?' + new URLSearchParams(postData).toString();
