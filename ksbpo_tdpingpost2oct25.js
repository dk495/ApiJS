function pingAPI() {
    ...
    formData.append('trackdrive_number', '+18559386082');
...
const originalUrl = 'https://digital-agents.trackdrive.com/api/v1/inbound_webhooks/ping/check_if_the_buyer_is_available?' + new URLSearchParams(formData).toString();
...
function postPingId(pingId) {
    ...
    const originalUrl = 'https://digital-agents.trackdrive.com/api/v1/inbound_webhooks/post/check_if_the_buyer_is_available?' + new URLSearchParams(postData).toString();;
