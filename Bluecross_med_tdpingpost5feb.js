function pingAPI() {
    ...
    formData.append('trackdrive_number', '+18338423372');
...
const originalUrl = 'https://voyant-digital-media-group-inc.trackdrive.com/api/v1/inbound_webhooks/ping/check_for_available_medicare_wt_buyers?' + new URLSearchParams(formData).toString();
...
function postPingId(pingId) {
    ...
    const originalUrl = 'https://voyant-digital-media-group-inc.trackdrive.com/api/v1/inbound_webhooks/post/check_for_available_medicare_wt_buyers?' + new URLSearchParams(postData).toString();
