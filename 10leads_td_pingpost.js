function pingAPI() {
    ...
    formData.append('trackdrive_number', '+18338880622');
    formData.append('traffic_source_id', '2157');
    api_tester(document.getElementById('caller_id').value);
    formData.append('caller_id', '+1' + document.getElementById('caller_id').value);


    
const originalUrl = 'https://talk-tactics.trackdrive.com/api/v1/inbound_webhooks/ping/check_for_available_buyers_on_aca_transfers?' + new URLSearchParams(formData).toString();
...
function postPingId(pingId) {
    const postData = {
        trackdrive_number: "+18338880622",
        traffic_source_id: "2157",
    ...
    const originalUrl = 'https://talk-tactics.trackdrive.com/api/v1/inbound_webhooks/post/check_for_available_buyers_on_aca_transfers?' + new URLSearchParams(postData).toString();;
