function pingAPI() {
    ...
    formData.append('trackdrive_number', '+12094073760');
    formData.append('traffic_source_id', '11219');
...
const originalUrl = 'https://elite-calls-com.trackdrive.com/api/v1/inbound_webhooks/ping/check_for_mva_agents?' + new URLSearchParams(formData).toString();
...
function postPingId(pingId) {
    const postData = {
        trackdrive_number: "+12094073760",
        traffic_source_id: "11219",
    ...
    const originalUrl = 'https://elite-calls-com.trackdrive.com/api/v1/inbound_webhooks/post/check_for_mva_agents?' + new URLSearchParams(postData).toString();
