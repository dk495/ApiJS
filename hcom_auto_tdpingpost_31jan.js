function pingAPI() {
    ...
    formData.append('trackdrive_number', '+18443205832');
    formData.append('traffic_source_id', '00001');
...
const originalUrl = 'https://mr-leads-network.trackdrive.com/api/v1/inbound_webhooks/ping/check_for_available_auto_ib_buyers?' + new URLSearchParams(formData).toString();
...
function postPingId(pingId) {
    const postData = {
        trackdrive_number: "+18443205832",
        traffic_source_id: "00001",
    ...
    const originalUrl = 'https://mr-leads-network.trackdrive.com/api/v1/inbound_webhooks/post/check_for_available_auto_ib_buyers?' + new URLSearchParams(postData).toString();
