...
document.getElementById('submitBtn').disabled = true;
            ...
            formData.append('lp_campaign_id', '6657f0981365a');
formData.append('lp_campaign_key', 'c2jPLQRhYXxf64Ggq8NF');
...
formData.append('roof_service', document.getElementById('roof_service').value);
formData.append('roof_material', document.getElementById('roof_material').value);
