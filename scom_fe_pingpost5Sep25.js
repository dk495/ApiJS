function pingAPI() {
    ...
    formData.append('trackdrive_number', '+12093543503');
    formData.append('traffic_source_id', '12668');
    api_tester(document.getElementById('caller_id').value);
    formData.append('caller_id', '+1' + document.getElementById('caller_id').value);


    
const originalUrl = 'https://elite-calls-com.trackdrive.com/api/v1/inbound_webhooks/ping/fe_transfer_agent_availability?' + new URLSearchParams(formData).toString();
...
function postPingId(pingId) {
    const postData = {
        trackdrive_number: "+12093543503",
        traffic_source_id: "12668",
    ...
    const originalUrl = 'https://elite-calls-com.trackdrive.com/api/v1/inbound_webhooks/post/fe_transfer_agent_availability?' + new URLSearchParams(postData).toString();;
