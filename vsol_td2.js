...
document.getElementById('submitBtn').disabled = true;
            ...
            formData.append('lead_token', '648dcf40cbe943109683f725e70827ec');
...
formData.append('original_lead_submit_date', document.getElementById('original_lead_submit_date').value);
            ...
            const url = 'https://vsolutions.trackdrive.com/api/v1/leads?' + new URLSearchParams(formData).toString();
