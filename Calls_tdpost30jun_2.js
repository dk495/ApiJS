...
document.getElementById('submitBtn').disabled = true;
    ...
    formData.append('lead_token', 'ec4577abdc5f4d1fb69b094a1066a5b4');
	...
	formData.append('trusted_form_cert_url', 'https://quotes.kproinsurance.com');
            ...
            const url = 'https://infoworx.trackdrive.com/api/v1/leads/capture?' + new URLSearchParams(formData).toString();
