...
const originalUrl = 'https://infoworx.trackdrive.com/api/v1/inbound_webhooks/ping/check_fe_agents?' + new URLSearchParams(formData).toString();
...
function postPingId(pingId) {
    ...
    const originalUrl = 'https://infoworx.trackdrive.com/api/v1/inbound_webhooks/post/check_fe_agents?' + new URLSearchParams(postData).toString();
