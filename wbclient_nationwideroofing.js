function pingAPI() {
    ...
    formData.append('trackdrive_number', '+18442233316');
...
function postPingId(pingId) {
    ...
    const originalUrl = 'https://voyant-digital-media-group-inc.trackdrive.com/api/v1/inbound_webhooks/post/check_agents_on_roofing?' + new URLSearchParams(postData).toString();;
