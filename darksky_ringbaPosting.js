...
formData.append('lead_generated', document.getElementById('lead_generated').value+':00Z');
      ...
      const url = 'https://display.ringba.com/enrich/2410323344495740321?' + new URLSearchParams(formData).toString();
