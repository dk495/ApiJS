function pingAPI() {
    ...
    formData.append('trackdrive_number', '+18883023944');
...
const originalUrl = 'https://adolicious-llc.trackdrive.com/api/v1/inbound_webhooks/ping/check_adolicious_buyers_medicare?' + new URLSearchParams(formData).toString();
...
function postPingId(pingId) {
    const postData = {
        trackdrive_number: "+18883023944",
        traffic_source_id: "99300",
    ...
    const originalUrl = 'https://adolicious-llc.trackdrive.com/api/v1/inbound_webhooks/post/check_adolicious_buyers_medicare';
