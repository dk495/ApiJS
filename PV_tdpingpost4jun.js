function pingAPI() {
    ...
    formData.append('trackdrive_number', '+18338771699');
    formData.append('traffic_source_id', '2623');
...
const originalUrl = 'https://global-digital-media.trackdrive.com/api/v1/inbound_webhooks/ping/check_if_the_buyer_is_available_to_take_the_call?' + new URLSearchParams(formData).toString();
...
function postPingId(pingId) {
    const postData = {
        trackdrive_number: "+18338771699",
        traffic_source_id: "2623",
    ...
    const originalUrl = 'https://global-digital-media.trackdrive.com/api/v1/inbound_webhooks/post/check_if_the_buyer_is_available_to_take_the_call?' + new URLSearchParams(postData).toString();
