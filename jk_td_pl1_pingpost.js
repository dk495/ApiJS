function pingAPI() {
    ...
    formData.append('trackdrive_number', '+18552214563');
...
const originalUrl = 'https://pegasus-leads.trackdrive.com/api/v1/inbound_webhooks/ping/check_for_available_aca_inbound_dynamic_net14_buyers?' + new URLSearchParams(formData).toString();
...
function postPingId(pingId) {
    ...
    const originalUrl = 'https://pegasus-leads.trackdrive.com/api/v1/inbound_webhooks/post/check_for_available_aca_inbound_dynamic_net14_buyers?' + new URLSearchParams(postData).toString();;
