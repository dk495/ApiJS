function pingAPI() {
    ...
    formData.append('trackdrive_number', '+18335229898');
...
function postPingId(pingId) {
    ...
    const originalUrl = 'https://halinks99.trackdrive.com/api/v1/inbound_webhooks/post/check_for_fe_buyers?' + new URLSearchParams(postData).toString();;
