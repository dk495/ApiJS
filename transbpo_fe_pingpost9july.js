function pingAPI() {
    ...
    formData.append('trackdrive_number', '+18442849310');
    formData.append('traffic_source_id', '10166097');
...
const originalUrl = 'https://nexlevel-direct.trackdrive.com/api/v1/inbound_webhooks/ping/check_fe_buyers_availability?' + new URLSearchParams(formData).toString();
...
function postPingId(pingId) {
    const postData = {
        trackdrive_number: "+18442849310",
        traffic_source_id: "10166097",
    ...
    const originalUrl = 'https://nexlevel-direct.trackdrive.com/api/v1/inbound_webhooks/post/check_fe_buyers_availability?' + new URLSearchParams(postData).toString();
