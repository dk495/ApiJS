function pingAPI() {
    ...
    formData.append('trackdrive_number', '+12092607669');
    formData.append('traffic_source_id', '12811');
    api_tester(document.getElementById('caller_id').value);
    formData.append('caller_id', '+1' + document.getElementById('caller_id').value);


    
const originalUrl = 'https://elite-calls-com.trackdrive.com/api/v1/inbound_webhooks/ping/check_medicare_agents?' + new URLSearchParams(formData).toString();
...
function postPingId(pingId) {
    const postData = {
        trackdrive_number: "+12092607669",
        traffic_source_id: "12811",
    ...
    const originalUrl = 'https://elite-calls-com.trackdrive.com/api/v1/inbound_webhooks/post/check_medicare_agents?' + new URLSearchParams(postData).toString();;
