function pingAPI() {
    ...
    formData.append('trackdrive_number', '+18448755211');
...
const originalUrl = 'https://run-path.trackdrive.com/api/v1/inbound_webhooks/ping/check_for_available_agents_on_fe?' + new URLSearchParams(formData).toString();
...
function postPingId(pingId) {
    ...
    const originalUrl = 'https://run-path.trackdrive.com/api/v1/inbound_webhooks/post/check_for_available_agents_on_fe?' + new URLSearchParams(postData).toString();
