    document.getElementById('leadForm').addEventListener('submit', function(event) {
            ...
            formData.append('lead_token', '476c5efe02ab41518ac93f914377efe2');
formData.append('traffic_source_id', 'MedXfer1040');
...
formData.append('jornaya_tf_combined', document.getElementById('jornaya_tf_combined').value);
