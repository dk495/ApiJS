...
function postPingId(pingId) {
    const postData = {
        trackdrive_number: "+18333132696",
        traffic_source_id: "2195",
    ...
    const url = 'https://corsproxy.io/?https://global-digital-media.trackdrive.com/api/v1/inbound_webhooks/ping/medicare_buyer_availability';
