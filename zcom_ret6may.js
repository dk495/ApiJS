document.getElementById('leadForm').addEventListener('submit', function(event) {
    ...
    formData.append('key', '9296d138-ae4b-414d-b570-86bce67e3528');
    formData.append('publisher_id', '916f26f0');
    ...
    formData.append('placement_id', document.getElementById('placement_id').value); 
