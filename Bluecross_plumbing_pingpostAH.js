function pingAPI() {
    ...
    formData.append('trackdrive_number', '+18449456262');
    formData.append('traffic_source_id', '3111');
...
const originalUrl = 'https://assured-health.trackdrive.com/api/v1/inbound_webhooks/ping/check_buyers_plumbing_transfers_net_30?' + new URLSearchParams(formData).toString();
...
function postPingId(pingId) {
    const postData = {
        trackdrive_number: "+18449456262",
        traffic_source_id: "3111",
    ...
    const originalUrl = 'https://assured-health.trackdrive.com/api/v1/inbound_webhooks/post/check_buyers_plumbing_transfers_net_30?' + new URLSearchParams(postData).toString();
