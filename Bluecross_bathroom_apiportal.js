...
document.getElementById('leadForm').addEventListener('submit', function(event) {
    ...
    pingData.append('lp_campaign_id', BATHROOM_CAMPAIGN_ID);
    pingData.append('lp_supplier_id', BATHROOM_SUPPLIER_ID);
    pingData.append('lp_key', BATHROOM_LP_KEY);
    pingData.append('affid', BATHROOM_AFFID);
    ...
    .then(pingResponse => {
        console.log('Bathroom PING Response:', pingResponse);
        ...
        if (pingResponse.status === 'ACCEPTED') {
            ...
            formData.append('lp_campaign_id', BATHROOM_CAMPAIGN_ID);
            formData.append('lp_supplier_id', BATHROOM_SUPPLIER_ID);
            formData.append('lp_key', BATHROOM_LP_KEY);
            formData.append('lp_ping_id', ping_id);
            formData.append('affid', BATHROOM_AFFID);
            ...
            .then(response => response.json())
            .then(postResponse => {
                console.log('Bathroom POST Response:', postResponse);
            ...
            .catch(error => {
                console.error('Bathroom POST Error:', error);
                const alert = `
    ...
    .catch(error => {
        console.error('Bathroom PING Error:', error);
        const alert = `
            <div class="alert alert-danger alert-dismissible fade show" role="alert">
