function pingAPI() {
    ...
    formData.append('trackdrive_number', '+12092607157');
    formData.append('traffic_source_id', '12362');
...
const originalUrl = 'https://elite-calls-com.trackdrive.com/api/v1/inbound_webhooks/ping/aca_transfers?' + new URLSearchParams(formData).toString();
...
function postPingId(pingId) {
    ...
    const originalUrl = 'https://elite-calls-com.trackdrive.com/api/v1/inbound_webhooks/post/aca_transfers?' + new URLSearchParams(postData).toString();
