function pingAPI() {
    ...
    formData.append('trackdrive_number', '+12095023129');
    formData.append('traffic_source_id', 'TS 48956');
    api_tester(document.getElementById('caller_id').value);
    formData.append('caller_id', '+1' + document.getElementById('caller_id').value);


    
const originalUrl = 'https://motiv8-marketing-group.trackdrive.com/api/v1/inbound_webhooks/ping/check_for_available_buyer_on_aca_blind_transfers?' + new URLSearchParams(formData).toString();
...
function postPingId(pingId) {
    const postData = {
        trackdrive_number: "+12095023129",
        traffic_source_id: "TS 48956",
    ...
    const originalUrl = 'https://motiv8-marketing-group.trackdrive.com/api/v1/inbound_webhooks/post/check_for_available_buyer_on_aca_blind_transfers?' + new URLSearchParams(postData).toString();;
