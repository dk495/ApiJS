function pingAPI() {
    ...
    formData.append('trackdrive_number', '+18338354480');
...
const originalUrl = 'https://ags-leads-llc.trackdrive.com/api/v1/inbound_webhooks/ping/check_for_available_agents_on_medicare?' + new URLSearchParams(formData).toString();
...
function postPingId(pingId) {
    const postData = {
        trackdrive_number: "+18338354480",
        traffic_source_id: "81",
    ...
    const originalUrl = 'https://ags-leads-llc.trackdrive.com/api/v1/inbound_webhooks/post/check_for_available_agents_on_medicare?' + new URLSearchParams(postData).toString();;
