function pingAPI() {
    ...
    formData.append('trackdrive_number', '+12097062494');
...
const originalUrl = 'https://elite-calls-com.trackdrive.com/api/v1/inbound_webhooks/ping/aca_180_availability?' + new URLSearchParams(formData).toString();
...
function postPingId(pingId) {
    const postData = {
        trackdrive_number: "+12097062494",
        traffic_source_id: "11729",
    ...
    const originalUrl = 'https://elite-calls-com.trackdrive.com/api/v1/inbound_webhooks/post/aca_180_availability?' + new URLSearchParams(postData).toString();
