function pingAPI() {
    ...
    formData.append('trackdrive_number', '+18775780509');
...
const originalUrl = 'https://elijay-marketing-solutions-beneficial-dream-5223.trackdrive.com/api/v1/inbound_webhooks/ping/check_for_available_agents_on_final_expense_transfer?' + new URLSearchParams(formData).toString();
...
function postPingId(pingId) {
    ...
    const originalUrl = 'https://elijay-marketing-solutions-beneficial-dream-5223.trackdrive.com/api/v1/inbound_webhooks/post/check_for_available_agents_on_final_expense_transfer?' + new URLSearchParams(postData).toString();
