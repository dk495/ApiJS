...
const originalUrl = 'https://rtb.ringba.com/v1/test/production/e5e1027378dd40b785911fea34d1b49d.json?exposeCallerId=yes&' + new URLSearchParams(formData).toString();
