function pingAPI() {
    ...
    formData.append('trackdrive_number', '+12094905542');
...
const originalUrl = 'https://elite-calls-com.trackdrive.com/api/v1/inbound_webhooks/ping/fe_agent_check?' + new URLSearchParams(formData).toString();
...
function postPingId(pingId) {
    ...
    const originalUrl = 'https://elite-calls-com.trackdrive.com/api/v1/inbound_webhooks/post/fe_agent_check?' + new URLSearchParams(postData).toString();;
