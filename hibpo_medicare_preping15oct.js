document.getElementById('leadForm').addEventListener('submit', function(event) {
    ...
    formData.append('lp_campaign_id', '68ee743f59afa');
    formData.append('lp_campaign_key', 'P2ZzkdbVNG9jMgtXYcWy');
    ...
    const url = 'https://bidsoncalls.leadspediatrack.com/call-preping.do?' + new URLSearchParams(formData).toString();
