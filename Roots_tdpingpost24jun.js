...
const originalUrl = 'https://cloud-call-communication.trackdrive.com/api/v1/inbound_webhooks/ping/check_for_available_hospital_indemnity_buyers?' + new URLSearchParams(formData).toString();
...
function postPingId(pingId) {
    ...
    const originalUrl = 'https://cloud-call-communication.trackdrive.com/api/v1/inbound_webhooks/post/check_for_available_hospital_indemnity_buyers?' + new URLSearchParams(postData).toString();
