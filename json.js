...
formData.append('gender', document.getElementById("genderDropdown").value);
...
formData.append('medicare_parts_a_b', 'True');
formData.append('tcpa_opt_in', 'True'); 
      ...
      const url = 'https://elite-calls-com.trackdrive.com/api/v1/leads/capture?' + new URLSearchParams(formData).toString();
