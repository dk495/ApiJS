function pingAPI() {
    ...
    formData.append('trackdrive_number', '+18446790228');
...
const originalUrl = 'https://evolvetech-innovations.trackdrive.com/api/v1/inbound_webhooks/ping/check_for_med_ib_sd_buyers?' + new URLSearchParams(formData).toString();
...
function postPingId(pingId) {
    ...
    const originalUrl = 'https://evolvetech-innovations.trackdrive.com/api/v1/inbound_webhooks/post/check_for_med_ib_sd_buyers?' + new URLSearchParams(postData).toString();
