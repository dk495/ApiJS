function pingAPI() {
    ...
    formData.append('trackdrive_number', '+18558435952');
    formData.append('traffic_source_id', '1078');
    api_tester(document.getElementById('caller_id').value);
    formData.append('caller_id', '+1' + document.getElementById('caller_id').value);


    
const originalUrl = 'https://wecall-pro.trackdrive.com/api/v1/inbound_webhooks/ping/check_for_buyer_availability_on_aca_cpl_blind_transfer?' + new URLSearchParams(formData).toString();
...
function postPingId(pingId) {
    const postData = {
        trackdrive_number: "+18558435952",
        traffic_source_id: "1078",
    ...
    const originalUrl = 'https://wecall-pro.trackdrive.com/api/v1/inbound_webhooks/post/check_for_buyer_availability_on_aca_cpl_blind_transfer?' + new URLSearchParams(postData).toString();;
