function pingAPI() {
    ...
    formData.append('trackdrive_number', '+18446042841');
...
const originalUrl = 'https://evolvetech-innovations.trackdrive.com/api/v1/inbound_webhooks/ping/check_for_final_expanse_sd_buyer_availability?' + new URLSearchParams(formData).toString();
...
function postPingId(pingId) {
    ...
    const originalUrl = 'https://evolvetech-innovations.trackdrive.com/api/v1/inbound_webhooks/post/check_for_final_expanse_sd_buyer_availability?' + new URLSearchParams(postData).toString();;
