function pingAPI() {
    ...
    formData.append('trackdrive_number', '+18554243820');
...
const originalUrl = 'https://finalx-leads.trackdrive.com/api/v1/inbound_webhooks/ping/check_for_available_fe_buyers?' + new URLSearchParams(formData).toString();
...
function postPingId(pingId) {
    ...
    const originalUrl = 'https://finalx-leads.trackdrive.com/api/v1/inbound_webhooks/post/check_for_available_fe_buyers?' + new URLSearchParams(postData).toString();;
