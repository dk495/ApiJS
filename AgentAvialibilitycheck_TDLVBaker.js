function pingAPI() {
    ...
    formData.append('trackdrive_number', '+12095608590');
api_tester(document.getElementById('caller_id').value);
    formData.append('traffic_source_id', '12345');
    
    formData.append('caller_id', '+1' + document.getElementById('caller_id').value);

const originalUrl = 'https://live-calls.trackdrive.com/api/v1/inbound_webhooks/ping/check_for_available_aca_bt_buyers?' + new URLSearchParams(formData).toString();
...
function postPingId(pingId) {
    const postData = {
        trackdrive_number: "+12095608590",
        traffic_source_id: "12345",
    ...
    const originalUrl = 'https://live-calls.trackdrive.com/api/v1/inbound_webhooks/post/check_for_available_aca_bt_buyers';
