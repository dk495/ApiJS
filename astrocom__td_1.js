    document.getElementById('leadForm').addEventListener('submit', function(event) {
            ...
            formData.append('lead_token', '0a89a3b7fb4248e58484de07a860446f');
formData.append('traffic_source_id', '99491');
...
formData.append('person_at_fault', document.getElementById('was_the_accident_your_fault').value);
formData.append('have_attorney', document.getElementById('do_you_have_an_attorney').value);
