    document.getElementById('leadForm').addEventListener('submit', function(event) {
            ...
            formData.append('vendor_id', '22597');
formData.append('post_key', '58dc2779ffffc3f46d215ebd34cc28b2');
...
formData.append('state', document.getElementById('state').value);
        formData.append('dob', document.getElementById('dob').value);
            ...
            const url = 'https://corsproxy.io/?https://absolute.tldcrm.com/post?' + new URLSearchParams(formData).toString();
