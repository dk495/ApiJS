function pingAPI() {
    ...
    formData.append('trackdrive_number', '+18332267297');
    formData.append('traffic_source_id', '1116');
    api_tester(document.getElementById('caller_id').value);
    formData.append('caller_id', '+1' + document.getElementById('caller_id').value);


    
const originalUrl = 'https://skymarketinggroup.trackdrive.com/api/v1/inbound_webhooks/ping/check_for_available_agents_on_auto?' + new URLSearchParams(formData).toString();
...
function postPingId(pingId) {
    const postData = {
        trackdrive_number: "+18332267297",
        traffic_source_id: "1116",
    ...
    const originalUrl = 'https://skymarketinggroup.trackdrive.com/api/v1/inbound_webhooks/post/check_for_available_agents_on_auto?' + new URLSearchParams(postData).toString();;
