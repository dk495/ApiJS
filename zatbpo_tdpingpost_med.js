...
document.getElementById('submitBtn').disabled = true;
            ...
            formData.append('trackdrive_number', '+18882865298');
...
formData.append('state', document.getElementById('state').value);
           ...
           formData.append('original_lead_submit_date', document.getElementById('original_lead_submit_date').value);
            ...
            const originalUrl = 'https://zat-technologies-llc.trackdrive.com/api/v1/inbound_webhooks/ping/check_for_available_medicare_buyers?' + new URLSearchParams(formData).toString();
...
function postPingId(pingId) {
    ...
    const originalUrl = 'https://zat-technologies-llc.trackdrive.com/api/v1/inbound_webhooks/post/check_for_available_medicare_buyers?' + new URLSearchParams(postData).toString();;
