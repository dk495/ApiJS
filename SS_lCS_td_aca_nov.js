function pingAPI() {
    ...
    formData.append('trackdrive_number', '+18557570297');
    formData.append('traffic_source_id', '1008');
    api_tester(document.getElementById('caller_id').value);
    formData.append('caller_id', '+1' + document.getElementById('caller_id').value);


    
const originalUrl = 'https://innovative-call-solutions.trackdrive.com/api/v1/inbound_webhooks/ping/check_for_available_buyers_on_new_aca_dialler?' + new URLSearchParams(formData).toString();
...
function postPingId(pingId) {
    const postData = {
        trackdrive_number: "+18557570297",
        traffic_source_id: "1008",
    ...
    const originalUrl = 'https://innovative-call-solutions.trackdrive.com/api/v1/inbound_webhooks/post/check_for_available_buyers_on_new_aca_dialler?' + new URLSearchParams(postData).toString();;
