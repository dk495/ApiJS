...
formData.append('jornaya_lead_id', document.getElementById('jornaya').value);
...
const originalUrl = 'https://rtb.ringba.com/v1/production/d06cfa63b7c8462083a3a6ac66017b06.json?exposeCallerId=yes&' + new URLSearchParams(formData).toString();
