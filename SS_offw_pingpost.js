function pingAPI() {
    ...
    formData.append('trackdrive_number', '+18774752794');
    formData.append('traffic_source_id', '563926');
...
const originalUrl = 'https://offerweb.trackdrive.com/api/v1/inbound_webhooks/ping/check_offerweb_buyers_aca?' + new URLSearchParams(formData).toString();
...
function postPingId(pingId) {
    ...
    const originalUrl = 'https://offerweb.trackdrive.com/api/v1/inbound_webhooks/post/check_offerweb_buyers_aca';
