function pingAPI() {
    ...
    formData.append('trackdrive_number', '+18444574378');
...
const originalUrl = 'https://adzino-llc.trackdrive.com/api/v1/inbound_webhooks/ping/check_for_available_buyers_on_auto_blind_transfers_sensitive?' + new URLSearchParams(formData).toString();
...
function postPingId(pingId) {
    ...
    const originalUrl = 'https://adzino-llc.trackdrive.com/api/v1/inbound_webhooks/post/check_for_available_buyers_on_auto_blind_transfers_sensitive?' + new URLSearchParams(postData).toString();
