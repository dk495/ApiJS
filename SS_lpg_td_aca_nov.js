function pingAPI() {
    ...
    formData.append('trackdrive_number', '+18336442366');
    formData.append('traffic_source_id', 'P1000125');
    api_tester(document.getElementById('caller_id').value);
    formData.append('caller_id', '+1' + document.getElementById('caller_id').value);


    
const originalUrl = 'https://the-lead-penguin.trackdrive.com/api/v1/inbound_webhooks/ping/check_for_available_aca_buyers?' + new URLSearchParams(formData).toString();
...
function postPingId(pingId) {
    const postData = {
        trackdrive_number: "+18336442366",
        traffic_source_id: "P1000125",
    ...
    const originalUrl = 'https://the-lead-penguin.trackdrive.com/api/v1/inbound_webhooks/post/check_for_available_aca_buyers?' + new URLSearchParams(postData).toString();;
