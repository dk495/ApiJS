document.getElementById('leadForm').addEventListener('submit', function(event) {
    ...
    const pingData = new FormData();
           pingData.append('lp_campaign_id', '667c0314db535');
pingData.append('lp_campaign_key', 'JcDNVHhGfQqytTC8FMWR');
...
pingData.append('kitchen_service', document.getElementById('kitchen_service').value);
...
formData.append('kitchen_service', document.getElementById('kitchen_service').value);
