function pingAPI() {
    ...
    formData.append('trackdrive_number', '+18442650602');
    formData.append('traffic_source_id', '1007');
...
formData.append('vehicle1_year', document.getElementById('car_year').value);
formData.append('vehicle1_make', document.getElementById('car_make').value);
formData.append('vehicle1_model', document.getElementById('car_model').value);
formData.append('driver1_sr22_required', document.getElementById('sr22').value);
formData.append('self_credit_rating', document.getElementById('self_credit_rating').value);
...
const originalUrl = 'https://the-mountaintop-affiliate-network.trackdrive.com/api/v1/inbound_webhooks/ping/check_for_agents_auto?' + new URLSearchParams(formData).toString();
...
function postPingId(pingId) {
  ...
  vehicle1_year: document.getElementById('car_year').value,
  vehicle1_make: document.getElementById('car_make').value,
