function pingAPI() {
    ...
    formData.append('trackdrive_number', '+18444932340');
...
const originalUrl = 'https://ital-life-llc.trackdrive.com/api/v1/inbound_webhooks/ping/check_for_available_medicare_buyers?' + new URLSearchParams(formData).toString();
...
function postPingId(pingId) {
    ...
    const originalUrl = 'https://ital-life-llc.trackdrive.com/api/v1/inbound_webhooks/post/check_for_available_medicare_buyers?' + new URLSearchParams(postData).toString();
