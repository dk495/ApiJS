function pingAPI() {
    ...
    formData.append('trackdrive_number', '+18446134248');
    formData.append('traffic_source_id', '1033');
    api_tester(document.getElementById('caller_id').value);
    formData.append('caller_id', '+1' + document.getElementById('caller_id').value);


    
const originalUrl = 'https://skymarketinggroup.trackdrive.com/api/v1/inbound_webhooks/ping/check_for_available_fe_buyers?' + new URLSearchParams(formData).toString();
...
function postPingId(pingId) {
    const postData = {
        trackdrive_number: "+18446134248",
        traffic_source_id: "1033",
    ...
    const originalUrl = 'https://skymarketinggroup.trackdrive.com/api/v1/inbound_webhooks/post/check_for_available_fe_buyers?' + new URLSearchParams(postData).toString();;
