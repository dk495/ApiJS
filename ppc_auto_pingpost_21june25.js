function pingAPI() {
    ...
    formData.append('trackdrive_number', '+18444412527');
    formData.append('traffic_source_id', '1070');
...
const originalUrl = 'https://powerful-proximity-consulting-llc.trackdrive.com/api/v1/inbound_webhooks/ping/check_for_available_buyers_on_auto_uninsured_transfer?' + new URLSearchParams(formData).toString();
...
function postPingId(pingId) {
    const postData = {
        trackdrive_number: "+18444412527",
        traffic_source_id: "1070",
    ...
    const originalUrl = 'https://powerful-proximity-consulting-llc.trackdrive.com/api/v1/inbound_webhooks/post/check_for_available_buyers_on_auto_uninsured_transfer?' + new URLSearchParams(postData).toString();
