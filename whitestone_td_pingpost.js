function pingAPI() {
    ...
    formData.append('trackdrive_number', '+18338111458');
    formData.append('traffic_source_id', '2392');
    api_tester(document.getElementById('caller_id').value);
    formData.append('caller_id', '+1' + document.getElementById('caller_id').value);

    
const originalUrl = 'https://global-digital-media.trackdrive.com/api/v1/inbound_webhooks/ping/check_for_aca_buyer_availability?' + new URLSearchParams(formData).toString();
...
function postPingId(pingId) {
    const postData = {
        trackdrive_number: "+18338111458",
        traffic_source_id: "2392",
    ...
    const originalUrl = 'https://global-digital-media.trackdrive.com/api/v1/inbound_webhooks/post/check_for_aca_buyer_availability';
