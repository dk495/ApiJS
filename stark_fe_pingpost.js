function pingAPI() {
    ...
    formData.append('trackdrive_number', '+18445096539');
    formData.append('traffic_source_id', '898998890018');
...
const originalUrl = 'https://yeetiq.trackdrive.com/api/v1/inbound_webhooks/ping/check_for_available_buyers_on_lifefinal_expense?' + new URLSearchParams(formData).toString();
...
function postPingId(pingId) {
    ...
    const originalUrl = 'https://yeetiq.trackdrive.com/api/v1/inbound_webhooks/post/check_for_available_buyers_on_lifefinal_expense?' + new URLSearchParams(postData).toString();;
