function pingAPI() {
    ...
    formData.append('trackdrive_number', '+18446048262');
...
formData.append('jornaya_lead_id_agent', document.getElementById('jornaya_leadid').value);
...
function postPingId(pingId) {
  ...
  jornaya_lead_id_agent: document.getElementById('jornaya_leadid').value
  };
