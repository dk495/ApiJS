function pingAPI() {
    ...
    formData.append('trackdrive_number', '+18447046723');
    formData.append('traffic_source_id', '2397');
...
const originalUrl = 'https://global-digital-media.trackdrive.com/api/v1/inbound_webhooks/ping/check_for_auto_buyer?' + new URLSearchParams(formData).toString();
...
function postPingId(pingId) {
    const postData = {
        trackdrive_number: "+18447046723",
        traffic_source_id: "2397",
    ...
    const originalUrl = 'https://global-digital-media.trackdrive.com/api/v1/inbound_webhooks/post/check_for_auto_buyer?' + new URLSearchParams(postData).toString();;
