function pingAPI() {
    ...
    formData.append('trackdrive_number', '+18442052776');
    formData.append('traffic_source_id', '3063');
...
const originalUrl = 'https://assured-health.trackdrive.com/api/v1/inbound_webhooks/ping/check_if_the_buyer_is_available_to_take_the_calls?' + new URLSearchParams(formData).toString();
...
function postPingId(pingId) {
    const postData = {
        trackdrive_number: "+18442052776",
        traffic_source_id: "3063",
  ...
  tcpa_opt_in: 'true'
    ...
    const originalUrl = 'https://assured-health.trackdrive.com/api/v1/inbound_webhooks/post/check_if_the_buyer_is_available_to_take_the_calls?' + new URLSearchParams(postData).toString();
