document.getElementById('leadForm').addEventListener('submit', function(event) {
    ...
    const url = 'https://corsproxy.io/?https://rtb.ringba.com/v1/production/8f270da66a4a40d8984239f772c5a177.json?exposeCallerId=yes&' + new URLSearchParams(formData).toString();
