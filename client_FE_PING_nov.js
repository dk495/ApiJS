function pingAPI() {
    ...
    formData.append('trackdrive_number', '+18552892177');
...
const originalUrl = 'https://corwin-insurance-agency-llc.trackdrive.com/api/v1/inbound_webhooks/ping/check_if_the_buyer_is_available?' + new URLSearchParams(formData).toString();
...
function postPingId(pingId) {
    ...
    const originalUrl = 'https://corwin-insurance-agency-llc.trackdrive.com/api/v1/inbound_webhooks/post/check_if_the_buyer_is_available?' + new URLSearchParams(postData).toString();;
