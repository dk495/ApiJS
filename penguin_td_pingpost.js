function pingAPI() {
    ...
    formData.append('trackdrive_number', '+18445112100');
    formData.append('traffic_source_id', 'P100326');
...
const originalUrl = 'https://the-lead-penguin.trackdrive.com/api/v1/inbound_webhooks/ping/buyer_availability_check_for_aca?' + new URLSearchParams(formData).toString();
...
function postPingId(pingId) {
    const postData = {
        trackdrive_number: "+18445112100",
        traffic_source_id: "P100326",
    ...
    const originalUrl = 'https://the-lead-penguin.trackdrive.com/api/v1/inbound_webhooks/post/buyer_availability_check_for_aca?' + new URLSearchParams(postData).toString();
