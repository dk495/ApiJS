function pingAPI() {
    ...
    formData.append('trackdrive_number', '+18556359591');
    ...
    formData.append('search_term', document.getElementById('search_term').value);
...
const originalUrl = 'https://pegasus-leads.trackdrive.com/api/v1/inbound_webhooks/ping/check_for_available_home_services_buyers?' + new URLSearchParams(formData).toString();
...
function postPingId(pingId) {
  ...
  search_term: document.getElementById('search_term').value,
    ...
    const originalUrl = 'https://pegasus-leads.trackdrive.com/api/v1/inbound_webhooks/post/check_for_available_home_services_buyers?' + new URLSearchParams(postData).toString();
